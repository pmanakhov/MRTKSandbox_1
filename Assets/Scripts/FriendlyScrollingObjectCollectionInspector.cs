...
using PaginationMode = Microsoft.MixedReality.Toolkit.UI.FriendlyScrollingObjectCollection.PaginationMode;

namespace Microsoft.MixedReality.Toolkit.Editor
{
    [CustomEditor(typeof(FriendlyScrollingObjectCollection))]
    public class FriendlyScrollingObjectCollectionInspector : UnityEditor.Editor
    {
        ...
        private FriendlyScrollingObjectCollection scrollView;
        ...
        private void OnEnable()
        {
            ...
            scrollView = (FriendlyScrollingObjectCollection)target;
